...
export const PAID_PLACEMENT_DEFINITIONS: PlacementDefinition[] = [
  ...
  },
  {
    ...
    where: "Homepage Featured Sponsors rail (+ feed-driven sponsor modules)",
  ...
  },
  {
    ...
    where: "Homepage top banner + Business Directory sidebar banner",
    how: "Approved banner creatives rendered in slot-based placements",
    limits: `Homepage top: ${BANNER_HOMEPAGE_TOP_CAP}; Directory sidebar: ${BANNER_SIDEBAR_CAP}`,
