    ...
    const mockOffers: AffiliateOffer[] = [
      {
        ...
        description:
          "Earn 15% every time someone upgrades their business to a Featured Sponsor package.",
      ...
      },
      {
        ...
        description:
          "Get $25 when a referral lists their first product on the Marketplace.",
      ...
      },
      {
        ...
        description:
          "Pocket 20 % recurring for every month your referral stays premium.",
    ...
    <>
      ...
      <div className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <section className="container mx-auto px-4 py-12">
          <h2 className="text-4xl font-bold text-gold-500 text-center mb-6">
            How It Works
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <h3 className="text-2xl font-semibold text-gold-500 mb-2">
                  {title}
                </h3>
        ...
        <section className="container mx-auto px-4 py-16">
          <h2 className="text-4xl font-bold text-gold-500 text-center mb-10">
            Current Offers
          </h2>
