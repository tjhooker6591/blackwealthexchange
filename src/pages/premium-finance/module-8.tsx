  ...
  return (
    <div className="min-h-screen bg-black text-white p-6 md:p-12">
      ...
      <p className="text-gray-300 text-lg max-w-3xl mx-auto text-center mb-4">
        Wealth is not truly powerful unless it lasts. This final module helps you protect what you have built legally, pass it on, and embed your values into your family is financial future.
      </p>

      <p className="text-gray-400 text-sm text-center mb-8">
        <strong>Featured Video:</strong> Estate Planning and Closing the Wealth Gap (PBS)<br />
        <strong>Why:</strong> This expert panel offers a powerful breakdown of how estate planning can close the racial wealth gap — and what steps to take now.
      </p>
      ...
      <section className="bg-gray-800 p-6 rounded-lg shadow-md max-w-4xl mx-auto mb-6">
        ...
        <ul className="list-disc text-gray-300 pl-6 space-y-2">
          ...
          <li>Minimize estate taxes and ensure your beneficiaries receive assets without delay.</li>
          <li>Write a legacy letter — your values matter just as much as your valuables.</li>
      ...
      <section className="bg-gray-800 p-6 rounded-lg shadow-md max-w-4xl mx-auto mb-8">
        <h2 className="text-2xl text-gold font-semibold mb-4">📥 Legacy Planning Tools</h2>
        <ul className="list-disc text-gray-300 pl-6 space-y-3">
          <li>
            <a href="/downloads/estate-planning-starter-kit.pdf" className="text-gold underline" target="_blank" rel="noopener noreferrer">
              Estate Planning Starter Kit
            </a>{" "}
            – Wills, living trusts, directives and simple legal tips
          </li>
          <li>
            <a href="/downloads/legacy-letter-template.pdf" className="text-gold underline" target="_blank" rel="noopener noreferrer">
              Legacy Letter Template
            </a>{" "}
            – Write your family a letter they will never forget
          </li>
          <li>
            <a href="/downloads/wealth-transfer-checklist.pdf" className="text-gold underline" target="_blank" rel="noopener noreferrer">
              Wealth Transfer Checklist
            </a>{" "}
            – What to review and prepare step by step
          </li>
          <li>
            <a href="/downloads/family-conversation-guide.pdf" className="text-gold underline" target="_blank" rel="noopener noreferrer">
      ...
      <section className="bg-gray-800 p-6 rounded-lg shadow-md max-w-4xl mx-auto mb-10">
        <h2 className="text-2xl text-gold font-semibold mb-4">💡 Final Reflection</h2>
        <p className="text-gray-300">
          Legacy is about more than dollars — it is about dignity, direction and generational impact.
          Take the time to document what matters most, protect it and share the wisdom that brought you here.
        </p>
      </section>
