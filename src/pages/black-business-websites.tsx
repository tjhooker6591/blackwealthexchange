  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen">
      <header className="hero bg-gray-800 p-20 text-center shadow-md">
        <h1 className="text-4xl font-bold text-gold">Black Website Listing Of Black Owned Business Directories</h1>
        <p className="text-lg mt-2 text-gray-300">
          Discover the most comprehensive list of Black Website that list Black owned and Our Black-owned business directories.
        </p>
        <div className="mt-4">
          <Link href="/">
      ...
      <div className="container mx-auto p-6">
        <div className="mt-6 space-y-6">
          {blackOwnedBusinessDirectories.map((directory, index) => (
            <div key={index} className="bg-gray-800 p-4 rounded shadow-md border border-gray-700">
              <h2 className="text-xl font-semibold text-gold">{directory.name}</h2>
              <p className="text-gray-300 mt-2">{directory.description}</p>
              <p className="mt-2 text-gray-400"><strong>Categories:</strong> {directory.categories}</p>
