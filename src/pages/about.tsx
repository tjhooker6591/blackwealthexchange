...
export default function About() {
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Mission & Constitutional Standpoint */}
      <section className="container mx-auto px-4 py-16 text-left">
        ...
        <div className="space-y-6 text-lg text-gray-300 max-w-4xl">
          <p>
            ...
            resolve. A deliberate and strategic stand against the centuries-long
            denial of Black economic self-determination. We are not here to
            reclaim what was never freely given—we are here to build what we
          ...
          <p>
            ...
            laying foundations that were never permitted to exist. And we will
            not be deterred.
          </p>
          ...
          <p>
            ...
            We reject those tactics. We reject intimidation, miseducation, and
            inherited lies that were never ours to carry.
          </p>
          ...
          <p>
            ...
            circulation of capital within our communities is not exclusion—it is
            creation. This begins at home.
          </p>

          <p>
            The foundation of this movement is rooted in domestic unity. Before
            we can expand globally, we must repair what was broken here—in the
          ...
          <p>
            ...
            power—Black Americans, Caribbeans, Africans, and the entire
            diaspora—strengthens as we organize with discipline at home. The
            movement begins domestically, but its resonance will echo worldwide.
          </p>
          ...
          <p>
            ...
            structural sabotage. The residue of that legacy remains visible in
            the economic disparities we face today. We are not here to revisit
          ...
          <p>
            ...
            thrive. We are acting on rights that have always belonged to us.
          </p>
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <p className="text-lg text-gray-300 max-w-4xl">
          Black Wealth Exchange is led by strategic organizers, business
          professionals, and advocates committed to building permanent economic
          infrastructure. In keeping with our security and operational strategy,
          leadership profiles are reserved for internal governance and legal
          compliance—ensuring the safety and longevity of the mission.
          <br />
          <br />
          This movement is not about personalities. It is about principles,
          strategy, and collective power.
        </p>
      </section>
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <p className="text-lg text-gray-300 max-w-4xl">
          ...
          strategic approach to collective advancement. Profit is a tool—not the
          purpose. The purpose is ownership, equity, and generational
          permanence.
        </p>
      </section>

      {/* Founding Constitutional Statement */}
      <section className="container mx-auto px-4 py-12">
        <h2 className="text-3xl font-bold text-gold mb-6">
          Founding Principle
        </h2>
        <div className="space-y-6 text-lg text-gray-300 max-w-4xl">
          <p>
            Throughout history, the economic power, ownership rights, and
            institutional access of the Black community have been deliberately
            obstructed—not by chance, but by calculated design. What was
            withheld was not charity, nor favor, but the rightful ability to
            build, own, invest, and prosper freely in a society that professed
            equality yet practiced exclusion.
          </p>

          <p>
            Black Wealth Exchange stands not as a petition for inclusion, nor as
            a request for participation in systems never built with us in mind.
            We stand as architects of a new foundation—a lawful, principled
            establishment of structures that secure Black economic agency.
          </p>

          <p>
            We recognize that history&apos;s denial does not diminish our right.
            We reject the notion that delayed justice excuses continued
            inequity. And we affirm that what was systematically withheld must
            now be systematically constructed—not through appeal to benevolence,
            but through deliberate action grounded in constitutional rights,
            economic law, and unbreakable collective will.
          </p>
          ...
          <p>
            With intelligence, with discipline, and with conviction, we build
            what was wrongfully denied. Not merely for today—but for the
            generations yet to come, who will inherit not memories of struggle
            alone, but legacies of ownership, prosperity, and unassailable
            economic power.
          </p>
        </div>
      </section>

      {/* Contact + Closing Declaration */}
      ...
      <section className="container mx-auto px-4 py-12 text-center">
        <p className="text-lg text-gold font-semibold">
          “We are not asking for acceptance. We are building what was wrongfully
          withheld.
          <br />
          We are not requesting inclusion. We are securing our rightful
          position.”
          <br />— Black Wealth Exchange
        </p>
      </section>
