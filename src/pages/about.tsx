    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="container mx-auto px-4 py-16 text-left">
        ...
        <div className="space-y-6 text-lg text-gray-300 max-w-4xl">
          ...
          <p>
            <strong className="text-gold">We understand the weight of our words.</strong> In a nation where language has been used to erase, distort, and suppress, we choose our words with precision and purpose. We speak not in anger, but in clarity. Not in division, but in direction. Our voice is not a whisper—it is a force.
          </p>
          <p>
          ...
          <p>
            For generations, this nation profited from the erasure of Black wealth—through stolen labor, exclusionary laws, redlining, and structural sabotage. The residue of that legacy is still visible in every economic disparity we face today. We are not here to revisit that pain. We are here to <strong>end it.</strong>
          </p>
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <ul className="space-y-4 text-gray-300 text-lg list-disc list-inside max-w-4xl">
          <li><strong>Economic Justice:</strong> Building structures that correct the historical denial of access to wealth and ownership.</li>
          <li><strong>Integrity and Accountability:</strong> Operating transparently, lawfully, and with unwavering commitment to community trust.</li>
          <li><strong>Generational Prosperity:</strong> Laying foundations not just for today, but for the prosperity of future Black generations.</li>
          <li><strong>Strategic Empowerment:</strong> Creating opportunities intentionally, with clear strategies and measurable outcomes.</li>
          <li><strong>Constitutional and Legal Affirmation:</strong> Asserting our rightful place in the economy under the protections afforded by law.</li>
        </ul>
      </section>
      ...
      <section className="container mx-auto px-4 py-12">
        <h2 className="text-3xl font-bold text-gold mb-6">Organizational Status</h2>
        <p className="text-lg text-gray-300 max-w-4xl">
      ...
      <section className="container mx-auto px-4 py-12">
        <h2 className="text-3xl font-bold text-gold mb-6">Founding Principle</h2>
        <div className="space-y-6 text-lg text-gray-300 max-w-4xl">
          <p>
