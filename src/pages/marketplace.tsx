    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="section bg-gray-900 p-6 my-6 rounded shadow-lg">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
            ...
            <div className="category-card bg-gray-800 p-4 rounded shadow-lg text-center">
              ...
              <p className="mt-2">
                Tech gadgets, software, and services from Black tech companies.
              </p>
            ...
            <div className="category-card bg-gray-800 p-4 rounded shadow-lg text-center">
              ...
              <p className="mt-2">
                Curated subscription boxes for beauty, food, fashion, or books
                by Black authors.
              </p>
            ...
            <div className="category-card bg-gray-800 p-4 rounded shadow-lg text-center">
              ...
              <p className="mt-2">
                Investment opportunities, financial literacy courses, and
                banking services.
              </p>
        ...
        <div className="section bg-gray-900 p-6 my-6 rounded shadow-lg">
          ...
          <p className="mt-2">
            Are you a Black entrepreneur? List your products on BWE Marketplace
        ...
        <div className="text-center p-8">
          ...
          <p className="mt-2">
            Every purchase helps build Black wealth. Find unique and
            high-quality products today.
          </p>
          <button className="mt-4 p-4 bg-gold text-black font-bold rounded">
