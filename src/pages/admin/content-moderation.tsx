const ContentModeration = () => {
    const flaggedContent = [
      { id: 1, title: "Investment Tips 101", type: "Article", flaggedBy: "User123" },
      { id: 2, title: "Community Post: Funding Help", type: "Post", flaggedBy: "User456" },
    ];
          ...
          <ul className="space-y-4">
            {flaggedContent.map((content) => (
              <li key={content.id} className="bg-gray-800 p-4 rounded">
                <p><strong>{content.title}</strong> ({content.type})</p>
                <p className="text-sm text-gray-400">Flagged by: {content.flaggedBy}</p>
                <div className="mt-2">
