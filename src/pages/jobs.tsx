        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-xl border border-yellow-500/30 bg-yellow-500/10 p-4">
            ...
            <div className="mt-1 text-sm text-gray-200">
              Search open roles and apply with a profile that travels with you.
            </div>
          </div>
          <div className="rounded-xl border border-blue-500/30 bg-blue-500/10 p-4">
            ...
            <div className="mt-1 text-sm text-gray-200">
              Publish jobs and review applicants from a focused talent pipeline.
            </div>
          </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-gray-800 bg-black/40 p-6">
            ...
            <p className="mt-2 text-sm text-gray-300">
              Connect with experienced professionals for guidance, strategy, and
              long-term growth.
            </p>
            <Link
              href="/mentorship"
          ...
          <div className="rounded-2xl border border-gray-800 bg-black/40 p-6">
            ...
            <p className="mt-2 text-sm text-gray-300">
              Build your profile once, apply faster, and keep your opportunities
              organized across the platform.
            </p>
