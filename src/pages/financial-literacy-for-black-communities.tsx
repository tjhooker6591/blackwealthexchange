...
export default function FinancialLiteracyLanding() {
  const title =
    "Financial Literacy for Black Communities | Black Wealth Exchange";
  const description = truncateMeta(
    "Learn practical budgeting, credit, investing, and wealth-building strategies designed for Black communities.",
  );
    ...
    <div className="min-h-screen bg-black text-white px-4 py-8">
      ...
      <div className="mx-auto max-w-4xl space-y-6 rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <p className="text-white/80">
          Build confidence with money decisions that matter: budgeting, debt
          reduction, credit repair, investing basics, and long-term wealth
          planning.
        </p>
        <ul className="list-disc ml-5 text-white/80 space-y-2">
          ...
          <li>
            Use practical cash-flow systems for family and business stability.
          </li>
        </ul>
        <div className="flex flex-wrap gap-2 text-sm">
          ...
          >
            Open financial literacy page
          </Link>
          <Link
            href="/wealth-building-resources"
            className="rounded-full border border-white/20 px-3 py-1 hover:bg-white/10"
          >
