...
function BulletList({ children }: { children: React.ReactNode }) {
  return (
    <ul className="list-disc ml-6 mt-2 space-y-2 text-gray-200">{children}</ul>
  );
}
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-10 sm:py-14">
            <div className="max-w-3xl">
              ...
              <p className="text-base sm:text-lg text-gray-200 mt-4">
                Black Wealth Exchange (“BWE”) is built on trust. This Privacy
                Policy explains what we collect, how we use it, when we share
        ...
        <main className="relative max-w-6xl mx-auto px-4 pb-14 space-y-8">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                ...
                <p className="text-sm text-gray-300 mt-2">
                  We do not sell personal information. If we ever change how we
                  use data in a way that affects your rights, we’ll update this
                  policy and provide notice when appropriate.
                </p>
              </div>
              ...
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                ...
                <p className="text-sm text-gray-300 mt-2">
                  We collect account details, listing info, and technical data
                  needed to operate and secure the platform, improve experience,
              ...
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                ...
                <p className="text-sm text-gray-300 mt-2">
                  You can update info, opt out of marketing, and request
                  access/correction/deletion of data by contacting us.
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 bg-black/40 border border-white/10 rounded-2xl p-5">
              ...
              <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 text-sm text-gray-200">
                ...
                <AnchorLink href="#info-we-collect">
                  3. Information We Collect
                </AnchorLink>
                <AnchorLink href="#sources">
                  4. Sources of Information
                </AnchorLink>
                <AnchorLink href="#how-we-use">
          ...
          >
            <p className="text-gray-200">
              Black Wealth Exchange (“Black Wealth Exchange,” “BWE,” “we,” “us,”
              or “our”) is a digital platform designed to connect users with
              Black-owned businesses, marketplace products, investment
              opportunities, and educational resources. Our mission is rooted in
              economic empowerment, financial literacy, and community
              upliftment.
            </p>
            <p className="text-gray-300 mt-3">
              This Privacy Policy applies to our website, apps, pages, and
              services that link to it (collectively, the “Services”).
            </p>
          </Card>
          ...
          >
            <BulletList>
              <li>
                ...
                identifies, relates to, describes, or can reasonably be linked
                to an individual (e.g., name, email, phone).
              </li>
              <li>
                <strong>Business Listing Information</strong> means data
                submitted for a public business profile (e.g., business name,
                category, website, address, description).
              </li>
              <li>
                <strong>Account</strong> means a registered profile that allows
                you to access features like saved listings, submissions,
                posting, checkout, and premium features.
              </li>
              <li>
                <strong>Service Providers</strong> are vendors that help us
                operate (e.g., hosting, payments, analytics, email).
              </li>
            </BulletList>
          </Card>
          ...
          >
            <p className="text-gray-200">
              We collect the following categories of information (some only when
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                ...
                <BulletList>
                  <li>
                    <strong>Identifiers:</strong> name, email, phone number (if
                    provided).
                  </li>
                  <li>
                    <strong>Account details:</strong> login method, account
                    type, preferences, saved items.
                  </li>
                </BulletList>
              </div>
              ...
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                <div className="text-yellow-200 font-extrabold">
                  B) Business & Seller Data
                </div>
                <BulletList>
                  <li>
                    <strong>Business listing info:</strong> business name,
                    categories, address/service area, description, website,
                    contact details, images you upload.
                  </li>
                  <li>
                    <strong>Seller/merchant info:</strong> product listings,
                    fulfillment details (as applicable).
                  </li>
                  <li>
                    <strong>Verification fields:</strong> information used to
                    validate listings (as applicable).
                  </li>
                </BulletList>
              </div>
              ...
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                ...
                <BulletList>
                  <li>
                    <strong>Activity:</strong> pages viewed, searches, clicks,
                    feature usage, session data.
                  </li>
                  <li>
                    <strong>Technical:</strong> IP address, device type,
                    browser, referrer URL, approximate location (derived from
                    IP).
                  </li>
                  <li>
                    <strong>Logs:</strong> error logs, security logs,
                    performance data.
                  </li>
                </BulletList>
              </div>
              ...
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                ...
                <BulletList>
                  <li>
                    <strong>Payment processing:</strong> handled by third
                    parties (e.g., Stripe). We receive confirmations and limited
                    transaction metadata (e.g., status, amount, timestamps), not
                    full card numbers.
                  </li>
                  <li>
                    <strong>Billing support:</strong> invoices/receipts and
              ...
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5 md:col-span-2">
                <div className="text-yellow-200 font-extrabold">
                  E) Optional Demographics (If You Choose)
                </div>
                <p className="text-gray-300 mt-2">
                  If you choose to provide demographic details (for example,
                  identifying as Black-owned), we use this information to
                  support discovery and highlight underrepresented businesses.
                  Providing this information is optional.
                </p>
                <BulletList>
                  <li>
                    We do not require demographic fields to use core features.
                  </li>
                  <li>
                    We do not use demographic fields to exclude or discriminate.
                  </li>
                  <li>
                    You can request removal of optional demographic details at
                    any time.
                  </li>
                </BulletList>
              </div>
          ...
          >
            <BulletList>
              <li>
                ...
                submit a listing, post content, make purchases, or contact
                support.
              </li>
              <li>
                <strong>Automatically:</strong> through logs, cookies, and
                analytics tools when you browse and interact with the Services.
              </li>
              <li>
                <strong>From service providers:</strong> transaction status from
                payment processors, or delivery confirmations from vendors (if
                used).
              </li>
              <li>
                <strong>Public sources (for listings):</strong> if we seed
                directory data from public sources or user submissions, we may
                store business-public details.
              </li>
            </BulletList>
          </Card>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 text-sm">
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                ...
                <BulletList>
                  <li>
                    Provide and maintain directory and marketplace features.
                  </li>
                  <li>
                    Create and manage accounts, authentication, and sessions.
                  </li>
                  <li>
                    Process transactions and deliver receipts/confirmations.
                  </li>
                  <li>
                    Enable submissions, moderation, and verification workflows.
                  </li>
                </BulletList>
              </div>
              ...
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                ...
                <BulletList>
                  <li>
                    Analyze usage to improve usability, speed, and reliability.
                  </li>
                  <li>
                    Personalize results (e.g., saved searches, preferences).
                  </li>
                  <li>
                    Develop new tools, educational content, and community
                    features.
                  </li>
                </BulletList>
              </div>
              ...
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                ...
                <BulletList>
                  <li>
                    Send service-related messages (password resets, receipts,
                    important updates).
                  </li>
                  <li>
                    Send marketing messages only where allowed; you can opt out
                    anytime.
                  </li>
            ...
            <div className="mt-5 bg-black/40 border border-white/10 rounded-2xl p-5">
              ...
              <p className="text-sm text-gray-300 mt-2">
                If you submit or claim a business listing, some information may
                appear publicly (such as business name, category, website,
                address/service area, and description). Do not submit sensitive
                personal details in public fields.
              </p>
            </div>
          </Card>
          ...
          >
            ...
            <BulletList>
              <li>
                ...
                delivery, customer support tooling, payment processing (e.g.,
                Stripe).
              </li>
              <li>
                <strong>Legal obligations:</strong> to comply with law,
                subpoenas, court orders, or lawful government requests.
              </li>
              <li>
                <strong>Safety and security:</strong> to investigate fraud,
                abuse, or threats and protect users and the platform.
              </li>
              <li>
                <strong>Business transfers:</strong> if we merge, acquire,
                reorganize, or sell assets, information may be transferred with
                notice as required.
              </li>
              <li>
                <strong>With your direction:</strong> when you choose to publish
                or share content (e.g., public business profile).
              </li>
            </BulletList>

            <FinePrint>
              If you use third-party links (e.g., a business’s website), their
              privacy practices apply. We are not responsible for third-party
              sites.
            </FinePrint>
          </Card>
          ...
          >
            <p className="text-gray-200">
              We use cookies and similar technologies. You can manage cookies in
              your browser settings. Disabling some cookies may affect
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                ...
                <p className="text-gray-300 mt-2">
                  Required for authentication, security, and core site behavior
                  (e.g., session cookies).
                </p>
              </div>
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                ...
                <p className="text-gray-300 mt-2">
                  Help us understand usage patterns (pages visited, performance)
              ...
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                ...
                <p className="text-gray-300 mt-2">
                  Remember your settings such as filters, tabs, or interface
                  preferences.
                </p>
              </div>
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                ...
                <p className="text-gray-300 mt-2">
                  Some browsers offer “Do Not Track” signals. There is no
                  universal standard; we respond as required by applicable law.
                </p>
              </div>
            </div>
          </Card>
          ...
          >
            <p className="text-gray-200">
              We retain data for as long as necessary to provide Services, meet
            ...
            <BulletList>
              <li>
                ...
                active; some records may remain for a period after deletion for
                compliance and security.
              </li>
              <li>
                <strong>Transaction records:</strong> retained as required for
                accounting, tax, and audit obligations.
              </li>
              <li>
                <strong>Security logs:</strong> retained for a limited period to
                detect and prevent fraud/abuse.
              </li>
              <li>
                <strong>Public listing data:</strong> may remain visible if it
                is a business-public profile; you can request updates or removal
                where applicable.
              </li>
            </BulletList>
            <FinePrint>
              If you request deletion, we may retain certain information when
              legally required or necessary for security and fraud prevention.
            </FinePrint>
          </Card>
          ...
          >
            <p className="text-gray-200">
              ...
              to protect information, including:
            </p>
            <BulletList>
            ...
            <div className="mt-4 bg-black/40 border border-white/10 rounded-2xl p-5">
              ...
              <p className="text-sm text-gray-300 mt-2">
                Use a strong password, don’t reuse passwords across sites, and
          ...
          >
            <p className="text-gray-200">
              You may have the right to request access, correction, deletion, or
              portability of your personal information, and to opt out of
              certain uses. We will respond as required by applicable law.
            </p>
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                ...
                <BulletList>
                  <li>
                    Update account details via your dashboard (where available).
                  </li>
                  <li>
              ...
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5">
                <div className="text-yellow-200 font-extrabold">
                  Request-based rights
                </div>
                <BulletList>
                  <li>Request access to data we hold about you.</li>
                  <li>Request correction of inaccurate information.</li>
                  <li>
                    Request deletion (subject to exceptions such as legal
                    compliance).
                  </li>
                </BulletList>
              </div>
              ...
              <div className="bg-black/40 border border-white/10 rounded-2xl p-5 md:col-span-2">
                ...
                <p className="text-gray-300 mt-2">
                  Email us at <strong>support@blackwealthexchange.com</strong>{" "}
                  with the subject line <strong>“Privacy Request”</strong> and
                  include:
                </p>
                <BulletList>
          ...
          >
            <p className="text-gray-200">
              ...
              the Services from outside the U.S., you understand that
              information may be processed and stored in the U.S. and other
              jurisdictions where our vendors operate.
            </p>
          </Card>
          ...
          >
            <p className="text-gray-200">
              BWE is not intended for children under 13. We do not knowingly
              collect personal information from children. If we learn that a
              child under 13 has provided personal information, we will delete
              it promptly.
            </p>
          </Card>
          ...
          >
            <p className="text-gray-200">
              ...
              technology, law, or our practices. When we do, we’ll update the
              “Last updated” date at the top. If changes are significant, we may
              notify you through email or a website banner.
            </p>
          </Card>
