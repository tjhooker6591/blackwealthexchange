        ...
        <div className="container relative z-10 mx-auto max-w-6xl px-4">
          <div className="text-center">
            ...
            <div className="mx-auto mt-4 flex w-full max-w-xl flex-col gap-2 sm:flex-row sm:justify-center">
              ...
              <Link href="/business-directory/add-business" className="w-full sm:w-auto" onClick={() => trackHomepageEvent("homepage_cta_clicked", { section: "hero", ctaId: "hero_add_business", ctaLabel: "Add Your Business", destination: "/business-directory/add-business" })}>
