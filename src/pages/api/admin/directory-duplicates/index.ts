...
export default async function handler(
  ...
  // route was only enforced when NODE_ENV === "production" -- any
  // authenticated user, admin or not, could access it in any other
  // environment. Also reimplemented its own JWT verification instead of
  // the shared, DB-re-verified requireAdminFromRequest. Both fixed by
