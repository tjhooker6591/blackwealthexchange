...
export default function MarketplaceSupportPage() {
  return (
    <>
      <Head>
        <title>Marketplace Support | Black Wealth Exchange</title>
        <meta
          name="description"
          content={truncateMeta(
            "Get help with Black Wealth Exchange marketplace orders, seller communication, delivery timing, and payment concerns.",
          )}
        />
        <link rel="canonical" href={canonicalUrl("/support/marketplace")} />
      </Head>
