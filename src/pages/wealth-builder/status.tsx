              ...
              <>
                ...
                <div className="mt-8 rounded-2xl border border-cyan-500/25 bg-cyan-500/5 p-6">
                  ...
                  <div className="mt-4 grid gap-3 md:grid-cols-3">
                    <Link href="/wealth-builder/transactions" className="rounded-xl border border-white/10 bg-black/30 p-4 hover:border-cyan-300/40">
                      <p className="text-sm font-semibold text-white">1) Keep transactions current</p>
                    ...
                    <Link href="/wealth-builder/budget" className="rounded-xl border border-white/10 bg-black/30 p-4 hover:border-cyan-300/40">
                      <p className="text-sm font-semibold text-white">2) Align budget to real spend</p>
                      <p className="mt-1 text-xs text-zinc-400">
                    ...
                    <Link href="/wealth-builder/debt" className="rounded-xl border border-white/10 bg-black/30 p-4 hover:border-cyan-300/40">
                      <p className="text-sm font-semibold text-white">3) Improve debt + savings pace</p>
                      <p className="mt-1 text-xs text-zinc-400">
