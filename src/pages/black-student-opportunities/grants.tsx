    ...
    <div className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="container mx-auto p-6 mt-12">
        ...
        <ul className="list-disc pl-6 space-y-4">
          <li>
            <strong>No Repayment Required:</strong> Unlike loans, grants are gift aid that doesn't need to be repaid.
          </li>
          <li>
          ...
          <li>
            <strong>Career Flexibility:</strong> Since grants don't need to be repaid, students have more freedom in
      ...
      <section className="container mx-auto p-6 mt-12">
        ...
        <div className="space-y-4">
          ...
          <p>
            <strong>State Grants:</strong> Check your state's higher education agency website for additional grant
            opportunities.
            <button
