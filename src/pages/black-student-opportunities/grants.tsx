    ...
    <div className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="container mx-auto p-6 mt-12">
        ...
        <ul className="list-disc pl-6 space-y-4">
          ...
          <li>
            <strong>Career Flexibility:</strong> Since grants don't need to be
            repaid, students have more freedom in their career choices after
            graduation.
          </li>
        </ul>
      </section>
      ...
      <section className="container mx-auto p-6 mt-12">
        ...
        <div className="space-y-4">
          ...
          <p>
            <strong>State Grants:</strong> Check your state's higher education
            agency website for additional grant opportunities.
            <button
              onClick={() =>
                handleExternalLink(
