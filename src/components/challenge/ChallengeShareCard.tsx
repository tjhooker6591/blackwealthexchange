...
const copyByVariant: Record<ShareVariant, string> = {
  signup:
    "I joined the BWE 0.5% Challenge. Search Black first. Buy, review, refer, repeat.",
  referral:
    "I joined the BWE 0.5% Challenge. Search Black first. Buy, review, refer, repeat.",
  search:
    "I found Black-owned businesses in my city on Black Wealth Exchange. Join the challenge.",
  business:
    "One small shift by millions of people can redirect billions into Black-owned businesses, jobs, ownership, and opportunity.",
  creator:
    "I joined the BWE 0.5% Challenge. Search Black first. Buy, review, refer, repeat.",
};
