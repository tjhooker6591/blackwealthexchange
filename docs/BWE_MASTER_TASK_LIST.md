...
| DA-05  | Marketplace public quality                                                | COMPLETE | `97fb3a1`   | Public marketplace now filters expired listings from listing/detail surfaces, blocks stale direct-checkout attempts in runtime, and replaces placeholder/internal seller copy with honest public messaging.   |
| DA-06  | Release history                                                           | ACTIVE   | `pending`   | Reconcile public release/history content to proven live functionality only. Current DA-06 closure work also corrected live marketplace/public-inventory copy, support metadata defaults across category plus alias/entry routes, storefront asset trust, and homepage sponsor/public-catalog truthfulness; record these as cross-workstream satisfaction for DA-08 and DA-09 rather than repeating them later. |
